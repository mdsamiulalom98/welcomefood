...
Route::group(['namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    ...
    Route::get('quick-view', [FrontendController::class, 'quick_view'])->name('product.quick_view');
    ...
    Route::post('wishlist/remove', [ShoppingController::class, 'wishlist_remove'])->name('wishlist.remove');
...
// ajax route
Route::get('/ajax-product-subcategory', [FoodController::class, 'getSubcategory']);
Route::get('/ajax-product-childcategory', [FoodController::class, 'getChildcategory']);
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    // product
    Route::get('foods/manage', [FoodController::class, 'index'])->name('foods.index');
    Route::get('foods/create', [FoodController::class, 'create'])->name('foods.create');
    Route::post('foods/save', [FoodController::class, 'store'])->name('foods.store');
    Route::get('foods/{id}/edit', [FoodController::class, 'edit'])->name('foods.edit');
    Route::post('foods/update', [FoodController::class, 'update'])->name('foods.update');
    Route::post('foods/inactive', [FoodController::class, 'inactive'])->name('foods.inactive');
    Route::post('foods/active', [FoodController::class, 'active'])->name('foods.active');
    Route::post('foods/destroy', [FoodController::class, 'destroy'])->name('foods.destroy');
    Route::get('foods/image/destroy', [FoodController::class, 'imgdestroy'])->name('foods.image.destroy');
    Route::get('foods/price/destroy', [FoodController::class, 'pricedestroy'])->name('foods.price.destroy');
    Route::get('foods/update-deals', [FoodController::class, 'update_deals'])->name('foods.update_deals');
    Route::get('foods/update-feature', [FoodController::class, 'update_feature'])->name('foods.update_feature');
    Route::get('foods/update-status', [FoodController::class, 'update_status'])->name('foods.update_status');
    Route::post('foods/barcode-update', [FoodController::class, 'barcode_update'])->name('foods.barcode_update');
    Route::get('foods/barcode', [FoodController::class,'barcode'])->name('foods.barcode');
    Route::get('barcodess', [FoodController::class, 'barcodess'])->name('barcodess.update');
    ...
    // delivery zone  route
    Route::get('delivery-zone/manage', [DeliveryZoneController::class, 'index'])->name('deliveryzones.index');
    Route::get('delivery-zone/create', [DeliveryZoneController::class, 'create'])->name('deliveryzones.create');
    Route::post('delivery-zone/save', [DeliveryZoneController::class, 'store'])->name('deliveryzones.store');
    Route::get('delivery-zone/{id}/edit', [DeliveryZoneController::class, 'edit'])->name('deliveryzones.edit');
    Route::post('delivery-zone/update', [DeliveryZoneController::class, 'update'])->name('deliveryzones.update');
    Route::post('delivery-zone/inactive', [DeliveryZoneController::class, 'inactive'])->name('deliveryzones.inactive');
    Route::post('delivery-zone/active', [DeliveryZoneController::class, 'active'])->name('deliveryzones.active');
    Route::post('delivery-zone/destroy', [DeliveryZoneController::class, 'destroy'])->name('deliveryzones.destroy');
