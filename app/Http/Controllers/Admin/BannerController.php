...
class BannerController extends Controller
{
    ...
    {
        $bannercategories = BannerCategory::orderBy('id', 'DESC')->select('id', 'name')->get();
        return view('backEnd.banner.create', compact('bannercategories'));
    }
    ...
    public function edit($id)
    {
        ...
        $bannercategories = BannerCategory::select('id', 'name')->get();
        return view('backEnd.banner.edit', compact('edit_data', 'bannercategories'));
    }
