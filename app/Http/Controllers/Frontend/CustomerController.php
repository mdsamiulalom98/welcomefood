...
class CustomerController extends Controller
{
    ...
    public function signin(Request $request)
    {
        $auth_check = Customer::where('phone', $request->phone)->first();
         $auth_check = Customer::select('id','phone','email', 'password', 'verify', 'status')->where('phone', $request->email_phone)->orWhere('email', $request->email_phone)->first();
    ...
    public function checkout(){
        $deliveryzones = DeliveryZone::where(['status' => 1,'only_pos'=>''])->get();
        ...
        return view('frontEnd.layouts.customer.checkout', compact('deliveryzones', 'bkash_gateway','shurjopay_gateway'));
    }
    ...
    public function order_save(Request $request)
    {
        ...
        $deliveryzone  = DeliveryZone::where('id', $request->area)->first();
    ...
    {
        $order = Order::where('id', $id)->with('orderdetails.image')->firstOrFail();
    ...
    public function profile_edit(Request $request)
    {
        ...
        return view('frontEnd.layouts.customer.profile_edit', compact('profile_edit', 'deliveryzones'));
    }
