    ...
    <div class="card-body">
      <div class="col-sm-12">
       <div class="form-group mb-3">
        ...
        <div class="pos_search">
            <input type="text" placeholder="Search Product Name ..." value="" class="search_click" name="keyword" autofocus/>
      ...
      <div class="col-sm-12">
       <table class="table table-bordered table-responsive-sm">
        ...
        <tbody id="cartTable">
         ...
         <tr>
           <td><img  src="{{asset($value->options->image)}}"> <p class="mt-1">{{$value->options->size}} </p></td>
          <td>{{$value->name}} </td>
          <td>
      ...
      <div class="col-sm-6">
       ...
       <div class="row new_customer">
        ...
        <div class="col-sm-12">
            <div class="form-group mb-3">
                 <select type="area" id="area" class="select2 form-control @error('area') is-invalid @enderror" name="area">
       ...
       <table class="table table-bordered">
        <tbody id="cart_details">
         @php 
           ...
           $subtotal = str_replace(',','',$subtotal); $subtotal = str_replace('.00', '',$subtotal);  
           $shipping = Session::get('pos_shipping')?Session::get('pos_shipping'):0;
           $pos_discount = Session::get('pos_discount')?Session::get('pos_discount'):0;
           $product_discount = Session::get('product_discount')?Session::get('product_discount'):0;
