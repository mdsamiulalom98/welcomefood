                            ...
                            <tr>
                                <td style="width: 40%; float: left; padding-top: 15px;">
                                    <img src="{{ asset($generalsetting->dark_logo) }}"
                                        style="margin-top: 15px !important;width: 85px;" alt="">
                                    <p style="font-size: 14px; margin-top:5px; color: #222;"><strong>Payment
                                            Method:</strong> <span
                            ...
                            <table class="table" style="width: 300px; float: right;    margin-bottom: 30px;">
                                <tbody style="background:#f1f9f8">
                                    <tr>
                                        ...
                                        <td><strong>{{ $order->amount + $order->discount - $order->shipping_charge }} Tk</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>{{ $order->discount }} Tk</strong></td>
                                    </tr>
                                    <tr style="background:#4DBC60;color:#fff">
                                        <td><strong>Final Total</strong></td>
                                        <td><strong>{{ $order->amount }} Tk </strong></td>
                                    </tr>
                                </tbody>
                            </table>
