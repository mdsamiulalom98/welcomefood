                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($data->orderdetails as $key => $food)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td><img src="{{ asset($food->image ? $food->image->image : '') }}"style="height: 50px;width:50px" alt=""></td>
                                        <td>{{ $food->food_name }} @if($food->size) | Size: {{$food->size}} @endif</td>
                                    </tr>
                                @endforeach
