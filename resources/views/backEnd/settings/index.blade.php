                            ...
                            <tbody>
                                @foreach ($show_data as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->name }}</td>
                                        <td><img src="{{ asset($value->white_logo) }}" style="height: 60px; width: auto;" alt="">
                                        </td>
                                        <td><img src="{{ asset($value->dark_logo) }}" style="height: 60px; width: auto;" alt="">
                                        </td>
                                        <td><img src="{{ asset($value->favicon) }}" style="height: 60px; width: auto;" alt="">
                                        </td>
                                        <td>
                                            @if ($value->status == 1)
                                        ...
                                        <td>
                                            <div class="button-list">
                                                @if ($value->status == 1)
                                                    <form method="post" action="{{ route('settings.inactive') }}"
                                                        class="d-inline">
                                                        @csrf
                                                ...
                                                @else
                                                    <form method="post" action="{{ route('settings.active') }}"
                                                        class="d-inline">
                                                        @csrf
                                                        <input type="hidden" value="{{ $value->id }}" name="hidden_id">
                                                        <button type="button"
