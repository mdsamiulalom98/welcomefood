    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('customers.ipblock.store') }}" method="POST" class="row mb-3"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ip_no') is-invalid @enderror"
                                        name="ip_no" value="{{ old('ip_no') }}" id="ip_no" required="">
                                    @error('ip_no')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea type="text" class="form-control @error('reason') is-invalid @enderror" name="reason"
                                        value="{{ old('reason') }}" id="reason" required=""></textarea>
                                    @error('reason')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button-list">
                                                <a class="btn btn-xs btn-primary waves-effect waves-light"
                                                    data-bs-toggle="modal" data-bs-target="#ipEdit{{ $value->id }}"><i
                                                        class="fe-edit-1"></i></a>

                                                <form method="post" action="{{ route('customers.ipblock.destroy') }}"
                                                    class="d-inline">
                                                    @csrf
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('customers.ipblock.update') }}" method="POST" class="row mb-3"
                            data-parsley-validate="" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    <label for="ip_no" class="form-label">IP No *</label>
                                    <input type="text" class="form-control @error('ip_no') is-invalid @enderror"
                                        name="ip_no" value="{{ $value->ip_no }}" id="ip_no" required="">
                                    @error('ip_no')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    <label for="reason" class="form-label">Reason *</label>
                                    <textarea type="text" class="form-control @error('reason') is-invalid @enderror" name="reason"
                                        value="{{ $value->reason }}" id="reason" required="">{{ $value->reason }}</textarea>
                                    @error('reason')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
